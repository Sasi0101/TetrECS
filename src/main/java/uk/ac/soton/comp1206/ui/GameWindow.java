...
public class GameWindow {
    ...
    /**
     * Display the InstructionsScene
     */
    public void startInstructionScene(){loadScene(new InstructionsScene(this));}

    /**
     * Displaying the ScoreScene
     * @param game the game we played
     */
    public void startScoreScene(Game game){loadScene(new ScoreScene(this, game));}

    /**
     * Displaying the HighScoreScene
     * @param s the string we are using
     * @param vbox1 passing through a verticalBoc
     * @param vbox2 passing through a second verticalBox
     * @param vbox3 passing through a third verticalBox
     */
    public void startHighScoreScene(String s, VBox vbox1, VBox vbox2, VBox vbox3){loadScene(new HighScoreScene(this, s, vbox1, vbox2, vbox3));}

    /**
     * Displaying the SettingsScene
     */
